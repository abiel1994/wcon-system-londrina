...
function simularTabela() {
  ...
  // 3. Supervisor/Supervisor Treinee — override sobre a equipe
  const regraEquipe = buscarRegraPorTabelaOuRef(DB.tabelasOverrideLider, 'tabela_id', _simulTabela, unidade);
  const pcEquipe = regraEquipe
